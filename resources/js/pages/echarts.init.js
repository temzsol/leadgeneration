...
// Doughnut Chart
    ...
    option = {
        ...
        color: ['#086070','#ed5e49','#2651e9','#fcb92c','#4aa3ff'],
        series: [
            {
                name: 'Total sales',
                type: 'pie',
    ...
    option = {
        ...
        series: [{
            ...
            itemStyle: {
                normal: {
                    shadowBlur: 10,
                    shadowColor: 'rgba(65,204,131, 0.5)',
                    shadowOffsetY: 5,
                    color: new echarts.graphic.RadialGradient(0.4, 0.3, 1, [{
                        offset: 0,
                        color: 'rgba(65,204,131, 0.1)',
                    }, {
                        offset: 1,
                        color: 'rgb(65,204,131)',
                    }])
                }
            }
        }, {
            ...
            itemStyle: {
                normal: {
                    shadowBlur: 10,
                    shadowColor: 'rgba(51,92,235, 0.5)',
                    shadowOffsetY: 5,
                    color: new echarts.graphic.RadialGradient(0.4, 0.3, 1, [{
                        offset: 0,
                        color: 'rgba(51,92,235, 0.1)',
                    }, {
                        offset: 1,
                        color: 'rgb(51,92,235)',
                    }])
        ...
        series: [
            {
                ...
                axisLine: {
                    lineStyle: {
                        color: [[0.2,'#086070'],[0.8,'#ed5e49'],[1,'#2651e9']],
                        width: 20
                    }
                },
