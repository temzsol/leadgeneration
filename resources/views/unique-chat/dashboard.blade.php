...
@section('title', 'Facebook Dashboard')
...
@section('page-title', 'Facebook Dashboard')
                            ...
                            @foreach ($users as $lead)
                                ...
                                <li id="chat-user-{{ $lead->id }}">
                                    <a href="#" class="mt-0 chat-user" 
                                        data-id="{{ $lead->id }}"
                                        data-name="{{ $lead->name }}" 
                                        data-conversation-id="{{ $lead->id }}" data-image="{{ asset('uploads/profile_pics/' . ($lead->profile_pic ?? 'default.jpg')) }}" >
                                        <div class="d-flex">
                                            <div class="user-img online align-self-center me-3">
                                                <img src="{{ asset('uploads/profile_pics/' . ($lead->profile_pic ?? 'default.jpg')) }}" 
