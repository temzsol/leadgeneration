                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="m_-1377519352946152473content" align="center" style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;padding:40px 48px 0">
                                                                                <h1 style="font-weight:300;font-size:28px;line-height:130%;margin:16px 0 0" align="center">Welcome to Forever Medspa</h1>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="m_-1377519352946152473content" style="font-family: Open Sans, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, Helvetica, Arial, sans-serif; padding: 40px 48px;">
                                                                                <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
                                                                                    ...
                                                                                    <p>Thank you for registering on our platform. We are excited to have you with us! Below are your login details:</p>
                                                                                    ...
                                                                                    <p>
                                                                                        <a href="https://myforeverspa.com/login" style="color: #3498db; text-decoration: none; font-weight: bold;">
                                                                                            Click here to log in
                                                                                        </a>
                                                                                    </p>
                                                                                    
                                                                                    <p>Thank you,<br>My Forever Medspa Team</p>
                                                                                </div>
                                                                                ...
                                                                                <table cellspacing="0" cellpadding="0" style="font-family: Open Sans, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, Helvetica, Arial, sans-serif; border-collapse: collapse; width: 100%;">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="font-family: Open Sans, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, Helvetica, Arial, sans-serif; width: 1%; padding-right: 16px;" valign="top">
                                                                                                <img src="https://forevermedspanj.com/wp-content/uploads/forever-color.fw_.png" width="150" height="60" alt="Forever Medspa Logo" style="line-height: 100%; border: 0; outline: none; text-decoration: none; vertical-align: baseline; font-size: 0;">
                                                                                            </td>
                                                                                ...
                                                                                <table>
                                                                                    <tr cellpadding="5">
                                                                                        <td style="margin-top: 5px;">Best regards,<br>Team Forever Medspa</td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                        </tr>
