                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="mb-3 my-4">
                                    ...
                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input input-mini"
                            ...
                            <div class="col-xl-2 col-md-6">
                                ...
                                <div class="mb-3" id="positionGroup">
                                    <div class="mb-4">
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="radio" id="radio5" name="positions"
                                                class="form-check-input" value="toast-top-right" checked />
                                            <label class="form-check-label" for="radio5">Top Right</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input type="radio" id="radio6" name="positions"
                                                class="form-check-input" value="toast-bottom-right" />
                                            <label class="form-check-label" for="radio6">Bottom Right</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input type="radio" id="radio7" name="positions"
                                                class="form-check-input" value="toast-bottom-left" />
                                            <label class="form-check-label" for="radio7">Bottom Left</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input type="radio" id="radio8" name="positions"
                                                class="form-check-input" value="toast-top-left" />
                                            <label class="form-check-label" for="radio8">Top Left</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input type="radio" id="radio9" name="positions"
                                                class="form-check-input" value="toast-top-full-width" />
                                            <label class="form-check-label" for="radio9">Top Full Width</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input type="radio" id="radio10" name="positions"
                                                class="form-check-input" value="toast-bottom-full-width" />
                                            <label class="form-check-label" for="radio10">Bottom Full Width</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input type="radio" id="radio11" name="positions"
                                                class="form-check-input" value="toast-top-center" />
                                            <label class="form-check-label" for="radio11">Top Center</label>
                                        </div>

                                        <div class="form-check mb-2">
                                            <input type="radio" id="radio12" name="positions"
                                                class="form-check-input" value="toast-bottom-center" />
