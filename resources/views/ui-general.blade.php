            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Four options are available: top, right, bottom, and left aligned.
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <p class="card-title-desc">Pagination links indicate a series of related content exists
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">If you don’t fancy a border spinner, switch to the grow spinner. While
                            it doesn’t technically spin, it does repeatedly grow!</p>
                        <div>
