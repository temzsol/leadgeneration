            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">We only set a <code class="highlighter-rouge">height</code> value on
                            the <code class="highlighter-rouge">.progress-bar</code>, so if you change
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Add <code class="highlighter-rounge">.animated-progess</code> class
                            with <code class="highlighter-rounge">.progress-bar</code> for animated progressbar.</p>
