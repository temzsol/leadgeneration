            ...
            <div class="col-xl-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">All HTML headings, <code class="highlighter-rouge">&lt;h1&gt;</code>
                            through <code class="highlighter-rouge">&lt;h6&gt;</code>, are available.</p>

                        <h1 class="mb-3">h1. Bootstrap heading <small class="text-muted">Semibold 2.25rem (36px)</small>
                        </h1>
                        <h2 class="mb-3">h2. Bootstrap heading <small class="text-muted">Semibold 1.8rem (28.8px)</small>
                        </h2>
                        <h3 class="mb-3">h3. Bootstrap heading <small class="text-muted">Semibold 1.575rem
                                (25.2px)</small></h3>
                        <h4 class="mb-3">h4. Bootstrap heading <small class="text-muted">Semibold 1.35rem (21.6px)</small>
                        </h4>
                        <h5 class="mb-3">h5. Bootstrap heading <small class="text-muted">Semibold 1.125rem (18px)</small>
                        </h5>
                        <h6 class="mb-0">h6. Bootstrap heading <small class="text-muted">Semibold 0.9rem (14.4px)</small>
                        </h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Traditional heading elements are designed to work best in the meat of
                            your page content. </p>
            ...
            <div class="col-xl-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Remove the default <code class="highlighter-rouge">list-style</code> and
                            left margin on list
