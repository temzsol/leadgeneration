            ...
            <div class="col-xl-9">
                <div class="card">
                    <div class="card-body p-4">
                        <div>
                            <h5>Welcome to Tocly!</h5>
                            <p class="text-muted">These terms and conditions outline the rules and regulations for the use of
                                Company Name's Website, located at Website.com.</p>
                            <p class="text-muted">By accessing this website we assume you accept these terms and conditions.
                                Do not continue to use Website Name if you do not agree to take all of the terms and
                                conditions stated on this page.</p>
                            <p class="text-muted">Most interactive websites use cookies to let us retrieve the user's details
                        ...
                        <div>
                            <h5>License</h5>
                            <p class="text-muted">Unless otherwise stated, Company Name and/or its licensors own the
                                intellectual property rights for all material on Website Name. All intellectual property
                                rights are reserved. You may access this from Website Name for your own personal use
                            ...
                            <p class="text-muted">Parts of this website offer an opportunity for users to post and exchange
                                opinions and information in certain areas of the website. Company Name does not filter,
                                edit, publish or review Comments prior to their presence on the website. Comments do not
                                reflect the views and opinions of Company Name,its agents and/or affiliates.</p>
                        </div>

                        <div>
                            <p class="text-muted">Company Name reserves the right to monitor all Comments and to remove any
                            ...
                            <p class="text-muted">You hereby grant Company Name a non-exclusive license to use, reproduce,
                            ...
                            <p class="text-muted fw-semibold">No use of Company Name's logo or other artwork will be allowed
                        ...
                        <div class="text-end">
                            ...
                            <a href="#!" class="btn btn-outline-danger"><i class="ri-close-line align-bottom me-1"></i>
                                Decline</a>
                        </div>
                    </div>
                </div>
