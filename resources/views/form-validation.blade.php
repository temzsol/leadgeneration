            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">We recommend using client-side validation, but in case you require
                            server-side validation, you can indicate invalid and valid form fields
                            with <code>.is-invalid</code> and <code>.is-valid</code>. Note that
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Validation styles are available for the following form controls and
                            components:
                        </p>
